...
<head>
    ...
    <title>Mobile to Engineer @ Ubon University - Portfolio</title>
...
<body>
    <!-- Navigation Bar -->
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background: linear-gradient(135deg, #8B4513 0%, #D4AF37 100%);">
        <div class="container-fluid">
            <a class="navbar-brand" href="#cover">
                <i class="fas fa-graduation-cap"></i> Mobile to Engineer
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <button class="btn btn-warning btn-sm ms-2" onclick="exportPDF()">
    ...
    <section id="cover" class="page-section cover-page" style="background: linear-gradient(135deg, #8B4513 0%, #D4AF37 50%, #8B4513 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; color: white;">
        <div class="container text-center">
            <div class="cover-content">
                ...
                <h1 class="display-3 fw-bold mb-3">วิชญาพร ยุวเรือง</h1>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="intro-card">
                        ...
                        <ul class="list-unstyled">
                            <li><strong>ชื่อ:</strong> <span id="intro_fullname">วิชญาพร ยุวเรือง</span></li>
        ...
        <div class="container py-5">
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ทำไมต้องเป็นวิศวกร?</h5>
